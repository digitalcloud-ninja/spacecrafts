![spacecraft-256x256.png](postman/.vuepress/public/images/spacecraft-256x256.png)
...
<!-- TOC -->
* [SpaceCrafts v1.0.0](#spacecrafts-v100)
  ...
  * [Endpoints](#endpoints)
    * [Authentication](#authentication)
      * [`POST`: `{baseUrl}/oauth2/token`](#post--baseurloauth2token)
      * [`POST`: `{baseUrl}/oauth2/revoke`](#post--baseurloauth2revoke)
    * [SpaceCrafts](#spacecrafts)
      * [`GET`: `{baseUrl}/spacecrafts/{spacecraftId}`](#get--baseurlspacecraftsspacecraftid)
  * [Components](#components)
    ...
    * [Responses](#responses)
      ...
      * [409 Not Conflict](#409-not-conflict)
...
> **Example:** We are going to start working on v2 with the addition of a new endpoint.
>
...
> **Hint** You also get a `403 Forbidden` when using the wrong `apiKey`
...
| **Content Type** | <ul><li>**application/x-www-form-urlencoded**</li>                                                                                           |
| **Required**     | <ul><li>**true**</li>                                                                                                                        |
...
| **Content Type** | <ul><li>**application/json**</li>                                                             |
| **Required**     | <ul><li>**true**</li>                                                                         |
| **RequestBody**  | <ul><li>**grant_type**: client_credential</li><li>**scope**: read:spacecrafts</li></ul>       |
| **Responses**    | <ul><li>**200** OK</li><li>**401** Unauthorized</li><li>**403** Forbidden</li></ul>           |
